...
6. Visit the [Pexels Documentation](https://raajtram.com/plugins/pexels/ "Pexels Documentation") page to see the plugin in action and other documentation.
...
1. Search results
2. Insert it into the post/page or use it as a Featured Image
